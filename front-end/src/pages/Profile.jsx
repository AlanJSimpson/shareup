                ...
                <div className={styles.user}>
                    <div className={styles.userLeft}>
                        ...
                        <div className={styles.userInfo}>
                            ...
                            <span className={styles.userEmail}><i className={cx("far fa-envelope", styles.userEmailIcon)}></i>{data[0].email}</span>
                        </div>
                    </div>
                    <div className={styles.userRight}>
                        <h3 className={styles.aboutMe}>Sobre Mim</h3>
                        <p className={styles.description}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum quo temporibus a enim veniam dolore inventore impedit quasi voluptas modi praesentium, ipsa excepturi amet est placeat.?</p>
                    </div>
                </div>
